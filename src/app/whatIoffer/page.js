  ...
  return (
    <header className="    text-white body-font">
      <div className="bg-gray-200">
       ...
       <div>
        <h1 className="text-center text-black text-5xl font-serif italic mt-14">What I offer</h1>
        <h1 className="text-center text-black text-4xl font-serif italic mt-4">Live Sessions</h1>
       </div>
       <div className="flex justify-center items-center h-screen">
          <video controls className="w-{100} h-full mt-14">
            <source
